...
const size_t MIN_QUAD_PROBES = 10000;
...
template <size_t key_dim>
__device__ inline bool key_cmp(const short* key1, const short* key2) {
    for(int i=0; i<key_dim; ++i) {
...
template <size_t key_dim>
__device__ inline int hash_lookup(const int* entries, const short* keys, size_t capacity, const short* key) {
